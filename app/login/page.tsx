    ...
    <div className="flex min-h-dvh flex-col bg-surface">
      ...
      <main id="main-content" className="flex flex-1 items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-soft">
            ...
            {reasonNotice && (
              <p
                role="status"
                className="mt-5 rounded-xl border-l-4 border-navy-light bg-navy-tint px-4 py-3 text-sm text-navy-dark"
              >
                {reasonNotice}
              </p>
            )}
