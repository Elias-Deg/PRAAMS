...
import { AppointmentRescheduleForm } from "@/components/appointment-reschedule-form";import { cancelAppointment } from "@/lib/actions/appointments";
...
export default async function AppointmentDetailPage({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      ...
      {terminalError && (
        <p role="alert" className="mt-5 rounded-2xl border-l-4 border-status-cancelled bg-white px-4 py-3 text-sm text-gray-800 shadow-soft">
      ...
      {isScheduled ? (
        mayManage ? (
          <section className="mt-8 grid gap-6 lg:grid-cols-[1fr_auto]">
            ...
            <div className="h-fit rounded-2xl border border-status-cancelled/40 bg-white p-6 shadow-soft lg:w-72">
